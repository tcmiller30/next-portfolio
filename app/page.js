      ...
      <>
        ...
        <div className="p-1 mx-auto rounded-xl text-sm text-justify shadow-xl bg-blue-700  md:text-lg md:w-full lg:w-10/12 ">
          <div className='bg-blue-950 p-4 rounded-xl'>
            <p className="mb-4 px-4 border-l-2 leading-relaxed bg-blue-"> My name is Travis Miller and I am a full-stack web developer currently based out of Orange County, CA. I used to work with coffee, but now I work with code.</p>
