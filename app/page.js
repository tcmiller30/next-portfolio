...
export default function Home() {
  return (
      ...
      <>
        <div className="mt-4 mx-auto w-1/3 pt-2 p-2 bg-blue-700 rounded-t-full  lg:p-4  ">
          ...
          />
            <h2 className="text-center font-bold md:text-lg">It&#39;s Nice to Meet You!</h2>
          </div>
        </div>
        
        <div className="p-8 mx-auto rounded-xl text-sm text-justify shadow-xl bg-blue-700 md:text-lg lg:w-4/5">
          ...
          <FaDesktop className='mx-auto fill-yellow-500 outline-blue-600' size={50}/>
        </div>
